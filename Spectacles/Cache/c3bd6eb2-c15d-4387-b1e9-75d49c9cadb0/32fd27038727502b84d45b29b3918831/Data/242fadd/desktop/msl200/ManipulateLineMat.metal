...
//}
//ubo int UserUniforms 2:24:4240 {
...
//float correctedIntensity 3744
//float4 intensityTextureSize 3760
//float4 intensityTextureDims 3776
//float4 intensityTextureView 3792
//float3x3 intensityTextureTransform 3808
//float4 intensityTextureUvMinMax 3856
//float4 intensityTextureBorderColor 3872
//float reflBlurWidth 3888
//float reflBlurMinRough 3892
//float reflBlurMaxRough 3896
//int overrideTimeEnabled 3900
//float overrideTimeElapsed 3904
//float overrideTimeDelta 3908
//int PreviewEnabled 3912
//int PreviewNodeID 3916
//float alphaTestThreshold 3920
//float startWidth 3924
//float endWidth 3928
//int visualStyle 3932
//float4 startColor 3936
//float4 endColor 3952
//float maxAlpha 3968
//bool Port_Value_N008 3972
//float3 Port_Import_N042 3984
//float3 Port_Import_N043 4000
//float Port_Import_N020 4016
//float Port_Import_N021 4020
//float Port_Import_N019 4024
//float Port_Input1_N014 4028
//float Port_Import_N044 4032
//float3 Port_Import_N052 4048
//float3 Port_Import_N016 4064
//float Port_Value3_N040 4080
//float Port_Import_N064 4084
//float3 Port_Import_N028 4096
//float Port_Value3_N060 4112
//float Port_Import_N074 4116
//float4 Port_Import_N032 4128
//float4 Port_Import_N033 4144
//float Port_Import_N034 4160
//float Port_Import_N076 4164
//float Port_Position1_N073 4168
//float Port_Value2_N067 4172
//float Port_Position2_N073 4176
//float Port_Position1_N070 4180
//float Port_Position1_N066 4184
//float4 Port_Value0_N077 4192
//float Port_Position1_N077 4208
//float4 Port_Value2_N077 4224
//}
...
{
float l9_377=2.0/log2((*sc_set2.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_376.z=((log2(fast::max((*sc_set2.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_376.w))*l9_377)-1.0)*l9_376.w;
}
float4 l9_378=l9_376;
l9_365=l9_378;
float4 l9_379=l9_365;
...
{
float l9_382=dot(l9_381,(*sc_set2.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_383=l9_382;
...
{
out.varClipDistance=l9_383;
}
}
float4 l9_384=float4(l9_380.x,-l9_380.y,(l9_380.z*0.5)+(l9_380.w*0.5),l9_380.w);
out.gl_Position=l9_384;
v=param_6;
